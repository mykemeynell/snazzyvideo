...
var VideoObject = /*#__PURE__*/function () {
  function VideoObject(DomObject, config, markers) {
  ...
  _createClass(VideoObject, [{
    ...
    key: "markerTemplate",
    value: function markerTemplate(label) {
      var template = "<div class=\"snazzyvideo-seeker-marker snazzyvideo-seeker-marker-hovered\">\n                            <div class=\"snazzyvideo-seeker-marker-label\">\n                                <span>" + label + "</span>\n                            </div>\n                        </div>";
      return template;
    }
  }, {
    key: "wrapperContainer",
    value: function wrapperContainer() {
    ...
    key: "addVideoElementIntoWrapper",
    value: function addVideoElementIntoWrapper() {
      this.wrapper.find('.snazzyvideo-element-wrapper').prepend(this.DomObject);
    }
  }, {
    key: "setTimestamps",
    value: function setTimestamps() {
      ...
      this.wrapper.find('.snazzyvideo-total-time > span').text(this.formatTime(this.duration)); // Update the length of the video in the wrapper

      this.wrapper.find('.snazzyvideo-current-time > span').text(this.formatTime(this.currentTime));
    }
  }, {
    key: "registerPlayPauseEvent",
    value: function registerPlayPauseEvent() {
      var _this = this;

      var playPauseButton = this.wrapper.find('[role="playPauseButton"]');

      if (this.config.debug) {
        console.debug("Registering click event for play/pause button", playPauseButton);
      }
      ...
      playPauseButton.on('click', function (event) {
        ...
        if (target.hasClass(VideoObjectClasses.getPlayButtonClass())) {
          if (_this.debug()) {
            console.info("Play event fired", _this.DomObject);
          }

          _this.DomObject[0].play();
        ...
        if (target.hasClass(VideoObjectClasses.getPauseButtonClass())) {
          if (_this.debug()) {
            console.info("Pause event fired", _this.DomObject);
          }

          _this.DomObject[0].pause();
    ...
    key: "registerTimeChangeEvent",
    value: function registerTimeChangeEvent() {
      var _this2 = this;

      var updateCurrentTimeStamp = function updateCurrentTimeStamp() {
        var currentTime = _this2.currentTime = _this2.DomObject[0].currentTime;

        _this2.wrapper.find('.snazzyvideo-current-time > span').text(_this2.formatTime(currentTime));
      };

      var updateSeekerPosition = function updateSeekerPosition() {
        var currentTime = _this2.currentTime = _this2.DomObject[0].currentTime;
        var duration = _this2.DomObject[0].duration;
        var percentPlayed = currentTime / duration * 100 + '%';

        _this2.wrapper.find('.snazzyvideo-seeker-current-position').css('left', percentPlayed);
      };
    ...
    key: "checkAirPlaySupport",
    value: function checkAirPlaySupport() {
      var _this3 = this;

      // TODO: Fix AirPlay support feature in browser. Doesn't appear to be working.
      var WebKitPlaybackTargetAvailabilityEvent = window.WebKitPlaybackTargetAvailabilityEvent;

      if (this.debug()) {
        console.info("Airplay support", WebKitPlaybackTargetAvailabilityEvent);
      }

      if (WebKitPlaybackTargetAvailabilityEvent) {
        this.DomObject.on('webkitplaybacktargetavailabilitychanged', function (event) {
          switch (event.availability) {
            case "available":
              _this3.wrapper.find('.snazzyvideo-airplay').css('display', 'flex');

              break;

            default:
              _this3.wrapper.find('.snazzyvideo-airplay').css('display', 'none');
...
var VideoObjectClasses = /*#__PURE__*/function () {
  function VideoObjectClasses() {
    _classCallCheck(this, VideoObjectClasses);
  }

  _createClass(VideoObjectClasses, null, [{
    key: "getPlayButtonClass",
    value: function getPlayButtonClass() {
      return 'snazzyvideo-play';
    }
  }, {
    key: "getPauseButtonClass",
    value: function getPauseButtonClass() {
      return 'snazzyvideo-pause';
    }
  }]);

  return VideoObjectClasses;
}();
...
/***/ 0:
/*!********************************************************!*\
  !*** multi ./src/js/htmlvideo.js ./src/sass/main.scss ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/myke/www/htmlvideo/src/js/htmlvideo.js */"./src/js/htmlvideo.js");
module.exports = __webpack_require__(/*! /Users/myke/www/htmlvideo/src/sass/main.scss */"./src/sass/main.scss");
